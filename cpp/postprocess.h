...
typedef struct
{
    // Ownership belongs to object_detect_result_list.  Each detection receives
    // one binary mask in source-image coordinates, rather than a single
    // class-coloured union mask.
    uint8_t *seg_mask;
